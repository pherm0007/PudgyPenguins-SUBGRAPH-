...
export class CreatePenguin extends ethereum.Event {
  get params(): CreatePenguin__Params {
    return new CreatePenguin__Params(this);
  }
}

export class CreatePenguin__Params {
  _event: CreatePenguin;

  constructor(event: CreatePenguin) {
    this._event = event;
  }
...
export class PudgyPenguins extends ethereum.SmartContract {
  static bind(address: Address): PudgyPenguins {
    return new PudgyPenguins("PudgyPenguins", address);
  }

  MAX_BY_MINT(): BigInt {
    let result = super.call("MAX_BY_MINT", "MAX_BY_MINT():(uint256)", []);

    return result[0].toBigInt();
  }

  try_MAX_BY_MINT(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("MAX_BY_MINT", "MAX_BY_MINT():(uint256)", []);
    if (result.reverted) {
  ...
  MAX_ELEMENTS(): BigInt {
    let result = super.call("MAX_ELEMENTS", "MAX_ELEMENTS():(uint256)", []);

    return result[0].toBigInt();
  }

  try_MAX_ELEMENTS(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("MAX_ELEMENTS", "MAX_ELEMENTS():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  try_price(_count: BigInt): ethereum.CallResult<BigInt> {
